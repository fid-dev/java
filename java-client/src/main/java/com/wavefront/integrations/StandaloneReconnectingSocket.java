 ...
 */
public class StandaloneReconnectingSocket {
  protected static final Logger logger = Logger.getLogger(StandaloneReconnectingSocket.class.getCanonicalName());
   ...
   */
  public StandaloneReconnectingSocket(String host, int port, SocketFactory socketFactory) throws IOException {
    this.host = host;
    this.port = port;
  ...
  public StandaloneReconnectingSocket(String host, int port) throws IOException {
